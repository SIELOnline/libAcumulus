...
class Translations extends TranslationCollection
{
    ...
    protected array $nl = [
        ...
        'message_warning_no_vattype' => 'Het factuurtype (https://acumulus.nl/facturen/facturen-naar-het-buitenland/4359/#Verschillende_type_facturen) kan niet bepaald worden. ' . self::sharedNl,
        'message_warning_multiple_vattypes' => 'Er zijn meerdere factuurtypes (https://acumulus.nl/facturen/facturen-naar-het-buitenland/4359/#Verschillende_type_facturen) mogelijk. ' . self::sharedNl,
    ...
    protected array $en = [
        ...
        'message_warning_no_vattype' => 'The invoice type for the invoice (https://acumulus.nl/facturen/facturen-naar-het-buitenland/4359/#Verschillende_type_facturen) could not be determined. The invoice has been saved as concept. Correct the invoice in Acumulus.',
        'message_warning_multiple_vattypes' => 'The invoice can have multiple vat types (https://acumulus.nl/facturen/facturen-naar-het-buitenland/4359/#Verschillende_type_facturen) . The invoice has been saved as concept. Correct the invoice in Acumulus.',
