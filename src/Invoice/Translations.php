...
class Translations extends TranslationCollection
{
    protected $nl = array(
        ...
        'message_warning_no_vattype_multiple_possible' => '%1$s Waarschijnlijk komt dit door een gebrek aan informatie over de aard van de bestelde artikelen. Het aanpassen van de "Over uw winkel" instellingen, indien mogelijk, zou kunnen helpen.',
    ...
    protected $en = array(
        ...
        'message_warning_no_vattype_multiple_possible' => '%1$s This is likely due to lack of information about the nature of the items sold. Refining your "About your shop" settings, if possible, may help.',
