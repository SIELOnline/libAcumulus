...
class MessageTest extends TestCase
{
    ...
    {
        $message = new Message(Severity::Error, 0, 'S1', 'Message 701');
    ...
    {
        $message = new Message(Severity::Success, 0, '', 'Message 701 empty codes');
    ...
    {
        $message = new Message(Severity::Warning, ['code' => 702, 'codetag' => 'W2', 'message' => 'Message 702']);
     ...
     */
    public function testFormat(Message $message1, Message $message2, Message $message3, Message $message4)
    {
