 ...
 * translations in the web shop specific way, this library defines its own way to get
 * translated texts.
 *
 ...
 * - The current language of the request should be passed tot the constructor and will be
 ...
 *   not overwrite already existing translations. This allows to define web shop specific
 ...
 *   per class. In these case overwriting is justified as these texts are typically loaded
 *   at instantiation time, not at the initialization of the library.
 *
