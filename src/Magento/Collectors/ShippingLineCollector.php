...
/**
 * ShippingLineCollector contains Magento specific {@see LineType::Shipping} collecting logic.
 *
...
class ShippingLineCollector extends LineCollector
{
    ...
    protected function getShippingLine(Line $line): void
    {
        ...
        if ($source->getType() === Source::Order || !Number::isZero($shopSource->getBaseShippingAmount())) {
