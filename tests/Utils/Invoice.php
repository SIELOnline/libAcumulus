 ...
 * - Assert that 2 Acumulus objects are equal
 * - Copy latest created test sources to test sources used for comparing.
 *   (if changes between them are checked and due to new developments).
 * - Update test sources used for comparing
 *   (when (massive) changes are made to e.g. meta fields).
 */
trait Invoice
{
    use Base;
