...
class Translations extends TranslationCollection
{
    protected $nl = array(
        ...
        'message_warning_line_without_vat' => 'Een van de factuurregels heeft geen BTW terwijl is ingesteld dat er "Alleen aan BTW onderhevige producten en/of diensten." aangeboden worden. Daarom is de factuur als concept opgeslagen. Corrigeer de factuur in Acumulus en controleer uw instellingen.',
