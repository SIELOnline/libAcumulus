 ...
 * classes:
 * - {@see \Siel\Acumulus\ApiClient\Acumulus}: Provides a facade to the Acumulus API methods. The
 ...
 * - {@see \Siel\Acumulus\ApiClient\AcumulusResult}: The result of an API call
 *   is returned as a {@see \Siel\Acumulus\ApiClient\AcumulusResult}. It
 *   contains:
 ...
 *     - A reference to the {@see \Siel\Acumulus\ApiClient\AcumulusRequest}.
 *     - References to the {@see \Siel\Acumulus\ApiClient\HttpResponse}
 *       and {@see \Siel\Acumulus\ApiClient\HttpRequest} objects of this call.
 ...
 * - {@see \Siel\Acumulus\ApiClient\AcumulusRequest}: Encapsulates knowledge
 ...
 *       {@see https://www.siel.nl/acumulus/API/Basic_Usage/ Basic Usage}").
 *   An {@see \Siel\Acumulus\ApiClient\AcumulusRequest} passes the request down
 *   to a {@see \Siel\Acumulus\ApiClient\HttpRequest}.
 * - {@see \Siel\Acumulus\ApiClient\HttpRequest}: Handles sending the request at
 *   the HTTP level:
 *     - Setting up the connection
 *     - Setting the method, the headers, and url-encoding the arguments.
 *     - Sending the http request.
 *     - The response is placed in a {@see \Siel\Acumulus\ApiClient\HttpResponse}.
 ...
 * - {@see \Siel\Acumulus\ApiClient\HttpResponse} An object used to capture the
 ...
 * {@see \Siel\Acumulus\ApiClient\AcumulusRequest} or
 * {@see \Siel\Acumulus\ApiClient\AcumulusResult}, except perhaps for future
 * support of other web services, e.g. looking for newer versions at GitHub or
 * validating VAT numbers with the VIES service.
 *
 * Note to developers: When implementing a new extension, you should normally
