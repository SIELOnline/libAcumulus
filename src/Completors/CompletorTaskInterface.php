 ...
 * {@see AcumulusObject}. For example, this may be 1 field, a few related fields, e.g.
 * all amount fields, or all {@see \Siel\Acumulus\Data\Line lines} of an
 * {@see \Siel\Acumulus\Data\Invoice}.
 *
 * Each Completor should be independent of other ones, though the order of execution may
 * be important to meet the preconditions (availability of other information).
 */
interface CompletorTaskInterface
{
     ...
     *   The object to complete. It is expected that, on returning, the object has been
     *   changed w.r.t. the task at hand.
     * @param mixed ...$args
