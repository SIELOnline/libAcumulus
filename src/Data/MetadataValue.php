 ...
 * - Processing: {@see \Siel\Acumulus\Collectors\Collector}s collect all
 *   information from the webshop that is needed to create a complete and
 *   correct Acumulus API message. This may contain information that is not
 *   directly mappable to Acumulus, as it requires more complex algorithms that
 *   may include multiple values and settings. To keep Collectors as simple as
 *   possible, a Collector just adds the raw data without processing it, which
 *   is left to the webshop independent code in the completor phase.
