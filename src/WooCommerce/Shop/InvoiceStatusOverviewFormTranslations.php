...
class InvoiceStatusOverviewFormTranslations extends TranslationCollection
{
    protected $nl = array(
        ...
        'concept_no_invoiceid' => 'Van deze conceptfactuur is nog geen definitieve factuur gemaakt.',
    ...
    protected $en = array(
        ...
        'concept_no_invoiceid' => 'This concept invoice has not yet been turned into a definitive invoice.',
