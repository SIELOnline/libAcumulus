...
class Translations extends TranslationCollection
{
    protected $nl = array(
        ...
        'message_warning_missing_amount_added' => 'Het factuurbedrag klopt niet met het totaal van de regels. Daarom is er een correctieregel toegevoegd met een bedrag (ex. btw) van €%1$.2f en een btw bedrag van €%2$.2f. De factuur is als concept opgeslagen. Controleer en corrigeer de factuur in Acumulus.',
        'message_warning_missing_amount_not_added' => 'Het factuurbedrag klopt niet met het totaal van de regels. Het %1$s wijkt €%2$.2f af. De factuur is als concept opgeslagen. Controleer en corrigeer de factuur in Acumulus.',
    ...
    protected $en = array(
        ...
        'message_warning_missing_amount_adde1' => 'Het factuurbedrag klopt niet met het totaal van de regels. Daarom is er een correctieregel toegevoegd met een bedrag (ex. btw) van €%1$.2f en een btw bedrag van €%2$.2f. De factuur is als concept opgeslagen. Controleer en corrigeer de factuur in Acumulus.',
        'message_warning_missing_amount_not_adde1' => 'Het factuurbedrag klopt niet met het totaal van de regels. Het %1$s wijkt €%2$.2f af. De factuur is als concept opgeslagen. Controleer en corrigeer de factuur in Acumulus.',
