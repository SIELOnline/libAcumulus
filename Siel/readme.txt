...
specifically aims at a Dutch public.
...
- Its own PSR-4 autoloader to circumvent the fact that many webshop/CMS systems
  still live in the pre PHP5.3, non OO, non namespace era, meaning that if an
  autoloader already exists it normally won't work with the PSR4 standard.
...
and only official text of it cvan be downloaded on
http://www.gnu.org/licenses/gpl.html. A non-binding dutch version can be found
on http://bartbeuving.files.wordpress.com/2008/07/gpl-v3-nl-101.pdf.
